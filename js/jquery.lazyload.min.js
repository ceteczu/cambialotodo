    ...
    c.fn.lazyload = function(a) {
        ...
        var h = this,
            d = {
                ...
                appear: null,
                load: null,
                placeholder: TT_CONFIG.staticUrl + "icon/loading.gif",
                errorImg: TT_CONFIG.staticUrl + "icon/imgNone377.jpg"
            };
        ...
        this.each(function() {
            var a = this,
                b = c(a);
            a.loaded = !1;
            (!1 === b.attr("src") || b.attr("src") === g) && b.is("img") && b.attr("src", d.placeholder);
            b.one("appear", function() {
                this.loaded || (d.appear && d.appear.call(a, h.length, d), c("\x3cimg /\x3e").bind("load", function() {
                ...
                }).attr("src", b.attr("data-" + d.data_attribute)), setTimeout(function() {
                    "icon/placeholder.gif" === b.attr("src") && b.is("img") && b.attr("src", d.errorImg)
                }, 3E3))
            });
